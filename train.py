...
if __name__ == '__main__':
    ...
    def network(sample):
        ...
        textual_input = sample['batch_text_tokens'].cuda()
        textual_mask = sample['batch_txt_mask'].cuda()
        visual_mask = sample['batch_visual_mask'].cuda()
        visual_input = sample['batch_vis_input'].cuda()
        map_gt = sample['batch_map_gt'].cuda()
        duration = sample['batch_duration']

        prediction, map_mask = model(textual_input, textual_mask, visual_input, visual_mask)
